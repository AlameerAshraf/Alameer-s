                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <label id="PasswordConfirmlb" runat="server" class="help-block" style="font-size: 12px; color: red; font-weight: bold;" ></label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <label class="checkbox">
                                ...
                                <label id="Termslb" runat="server" class="help-block" style="color: red; font-weight: bold;" ></label>
                            </label>
                        </div>
